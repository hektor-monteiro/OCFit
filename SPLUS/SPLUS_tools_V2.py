...
#
def load_mod_grid(dir, isoc_set='SPLUS'):
    global mod_grid
    global age_grid
    global z_grid
    ...
    if(isoc_set == 'SPLUS'):
        mod_grid = np.load(dir+'full_isoc_SPLUS_CMD33.npy')
...
def ccm_coefs(band):
    ...
    dict_94 = {'Bmag': [4460.62, 0.9999253931841896, 0.94553192328962365],
            ...
            'uJAVAmag': [3511.74, 0.9356957739989868, 2.0244002063831257],
            'F378mag': [3784.04, 0.9721236923030001, 1.7148988473967546],
            'F395mag': [3951.82, 0.9800906971476563, 1.5475803518370963],
            'F410mag': [4104.5, 0.9861986698324691, 1.377192709149926],
            'F430mag': [4303.83, 0.9951697149915807, 1.13038382642488],
            'gSDSSmag': [4821.55, 1.0148461112314209, 0.502129433946693],
            'F515mag': [5153.59, 1.0141037971710485, 0.20399620241216884],
            'rSDSSmag': [6255.93, 0.9379283138554416, -0.22466605859751532],
            'F660mag': [6603.23, 0.9050164571485194, -0.2897712652644059],
            'iSDSSmag': [7696.31, 0.8078592692876314, -0.5129090983977209],
            'F861mag': [8615.71, 0.7231533999075814, -0.6378915991757135],
            'zSDSSmag': [9609.69, 0.6119977055231964, -0.5618863951406351]}
